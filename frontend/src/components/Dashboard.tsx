...
export default function Dashboard() {
  ...
  const { balance, loading: balanceLoading, error: balanceError } = useBalance(userId);
  const {
    transactions,
  ...
  useEffect(() => {
    ...
    if (previousTransactionCount.current && txArray.length > previousTransactionCount.current) {
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-xl text-base text-gray-600">
                Track balances, rewards, and token activity across your multi-currency wallets with
                instant updates.
              </p>
            </div>
          ...
          <div className="rounded-xl border border-indigo-100 bg-gradient-to-br from-indigo-50 to-purple-50 p-8 text-center">
            <div className="mx-auto max-w-md space-y-4">
              ...
              <p className="text-slate-600">
                Your dashboard is ready. Get started by adding funds to unlock all platform features
                including crypto trading, token management, and rewards.
              </p>
              <button
                onClick={() => {
                  if (!topUpLoading) {
            ...
            {(
              ...
              >
                ...
                <p className="mt-2 text-2xl font-bold text-slate-800">
                  ...
                  <span className="text-base font-semibold text-slate-400">{entry.suffix}</span>
                </p>
