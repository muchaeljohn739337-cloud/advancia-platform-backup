...
export default function BonusCard({ earnings, percentage, delay = 0 }: BonusCardProps) {
    ...
    >
      ...
      <div className="relative flex items-start justify-between">
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2">
            ...
            <motion.div animate={{ rotate: showTooltip ? 180 : 0 }} transition={{ duration: 0.3 }}>
          ...
          <motion.div
            ...
            className="space-y-1"
          >
            <span className="text-3xl font-bold text-slate-800 block">${earnings.toFixed(2)}</span>
            <span className="text-sm text-amber-600 font-semibold">{percentage}% this month</span>
          </motion.div>
        </div>
      ...
      >
        ...
        <p className="text-slate-300">
          Earn {percentage}% on every credit transaction. Bonuses are calculated monthly and added
