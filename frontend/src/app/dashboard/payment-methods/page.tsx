                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2">
                              <h3 className="text-lg font-semibold text-gray-900">{sub.planName}</h3>
                            ...
                            <div className="space-y-1 text-sm text-gray-600">
                              <p>
                                <strong className="font-medium text-gray-900">${sub.amount}</strong> /{" "}
                                {sub.interval}
                              </p>
                              <p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800">
                All payment information is securely stored and processed by Stripe. We never store your full card
