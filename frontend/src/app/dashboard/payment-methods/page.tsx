                ...
                {subscriptions.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    {subscriptions.map((sub) => (
                      <div key={sub.id} className="border border-gray-200 rounded-lg p-4 sm:p-6">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800">
                All payment information is securely stored and processed by Stripe. We never store
