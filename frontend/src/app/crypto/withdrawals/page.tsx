                  ...
                  <div className="space-y-4">
                    ...
                    <div className="py-3 border-b border-gray-200 dark:border-gray-700">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <button
                          onClick={() =>
                            copyToClipboard(selectedWithdrawal.walletAddress, 'Address')
                          }
                    ...
                    {selectedWithdrawal.transactionHash && (
                      <div className="py-3 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <button
                            onClick={() =>
                              copyToClipboard(selectedWithdrawal.transactionHash!, 'TX Hash')
                            }
                            className="px-3 py-1 bg-indigo-600 text-white rounded text-xs hover:bg-indigo-700"
                          >
                            Copy
                    ...
                    {selectedWithdrawal.status === 'PENDING' && (
                      <div className="mt-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                        <p className="text-sm text-yellow-800 dark:text-yellow-200">
                          ⏳ Your withdrawal is pending admin approval. This usually takes up to 24
                          hours.
                        </p>
                      </div>
                    )}
