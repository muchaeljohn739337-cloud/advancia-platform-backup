              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                <div className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center py-3 border-b border-gray-200 dark:border-gray-700">
                      <span className="text-gray-600 dark:text-gray-400">USD Paid:</span>
                      <span className="font-bold text-lg text-gray-900 dark:text-white">
                    ...
                    {selectedOrder.adminWalletAddress && (
                      <div className="py-3 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <button
                            onClick={() =>
                              copyToClipboard(selectedOrder.adminWalletAddress!, 'Address')
                            }
                    ...
                    {selectedOrder.transactionHash && (
                      <div className="py-3 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <button
                            onClick={() =>
                              copyToClipboard(selectedOrder.transactionHash!, 'TX Hash')
                            }
                            className="px-3 py-1 bg-indigo-600 text-white rounded text-xs hover:bg-indigo-700"
                          >
                            Copy
