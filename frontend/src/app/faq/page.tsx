          ...
          <div className="max-w-5xl mx-auto px-6 py-16">
            ...
            >
              <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-blue-100 to-purple-100 rounded-full">
                ...
                <span className="text-blue-900 font-semibold">Frequently Asked Questions</span>
              </div>
        ...
        <div className="max-w-5xl mx-auto px-6 py-12">
          {filteredFAQs.length === 0 ? (
            ...
            >
              ...
              <p className="text-xl text-slate-500">No FAQs found matching your search.</p>
              <button
                ...
                >
                  ...
                  >
                    <div className="flex-1">
                      <div className="text-xs font-semibold text-blue-600 mb-1">{faq.category}</div>
                  ...
                  <AnimatePresence>
                    {expandedIndex === index && (
                      ...
                      >
                        <div className="px-6 py-5 text-slate-600 leading-relaxed">{faq.answer}</div>
                      </motion.div>
                    )}
                  </AnimatePresence>
                </motion.div>
        ...
        <div className="max-w-5xl mx-auto px-6 pb-20">
          ...
          >
            ...
            <p className="text-lg text-blue-100 max-w-2xl mx-auto leading-relaxed mb-8">
              Our support team is here to help 24/7. Get instant answers from our AI chatbot or
