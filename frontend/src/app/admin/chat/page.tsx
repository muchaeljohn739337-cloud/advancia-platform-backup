...
export default function AdminChatMonitor() {
  ...
  useEffect(() => {
    ...
    s.on(
      ...
      (ticket: { id: string; subject: string; userId: string; createdAt: string }) => {
        setEvents((e) => [
          {
    ...
    return (
      <div className="p-6">
        ...
        <p className="text-sm text-gray-600">
          Paste an admin Bearer token into localStorage as &apos;token&apos; and reload.
        </p>
      </div>
    );
  }
...
function Header({ count }: { count: number }) {
  return (
    <div className="flex items-center justify-between">
      ...
      <a href="/admin/tickets" className="text-blue-600 hover:underline flex items-center gap-2">
        Tickets
