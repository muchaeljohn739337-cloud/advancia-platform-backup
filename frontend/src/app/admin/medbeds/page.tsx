    ...
    <RequireRole roles={['ADMIN']}>
      <div className="max-w-7xl mx-auto p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600">Manage all Med Beds appointments and sessions</p>
        </div>
                ...
                <tbody>
                  {bookings.map((b) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-4">
                        <div>
                          <p className="font-medium text-gray-900">{b.chamberName}</p>
                          <p className="text-xs text-gray-500 capitalize">{b.chamberType}</p>
                        </div>
                      </td>
                      ...
                      <td className="px-4 py-4 text-sm text-gray-700">{b.duration} min</td>
                      <td className="px-4 py-4">
                      ...
                      <td className="px-4 py-4">
                        ...
                        {b.effectiveness !== null && b.effectiveness !== undefined && (
                            ...
                            <>
                              <button
                                onClick={() => {
                                  ...
                                  if (effectiveness && !isNaN(Number(effectiveness))) {
                                    updateEffectiveness(
                                      b.id,
                                      Math.min(100, Math.max(0, Number(effectiveness)))
                                    );
