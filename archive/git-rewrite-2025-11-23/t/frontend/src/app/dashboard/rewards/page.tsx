          ...
          <div className="p-4 sm:p-6">
            ...
            {activeTab === "tier" && tier && (
              <div className="space-y-6">
                <div
                  className={`bg-gradient-to-r ${getTierColor(tier.currentTier || "BRONZE")} p-6 sm:p-8 rounded-xl text-white`}
                >
                    ...
                    <div className="flex items-center space-x-3 sm:space-x-4 flex-1 min-w-0">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs sm:text-sm text-gray-600">
                          <span
                            className={`inline-block px-2 py-0.5 rounded text-xs ${getTierColor(user.tier)} text-white`}
                          >
                            {user.tier}
                          </span>
                        </div>
